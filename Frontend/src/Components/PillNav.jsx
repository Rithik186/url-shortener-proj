...
const PillNav = ({
  ...
  const cssVars = {
    ...
    ['--hover-circle-bg']: hoverCircleColor || (baseColor === '#fff' || baseColor === '#ffffff' ? '#120F17' : baseColor),
    ['--nav-h']: '42px',
    ['--logo']: '36px',
    ['--pill-pad-x']: '18px',
    ['--pill-gap']: '3px'
  ...
  return (
    <div className="fixed top-[1.2em] z-[1000] w-full left-0 md:w-auto md:left-1/2 md:-translate-x-1/2">
      ...
      >
        ...
        <div
          ref={navItemsRef}
          className="relative items-center rounded-full hidden md:flex ml-2 shadow-md border border-solid border-surface-200 dark:border-surface-800"
          style={{
            height: 'var(--nav-h)',
              ...
              const PillContent = (
                <>
                  <span
                    ...
                    style={{
                      background: 'var(--hover-circle-bg, #000)',
        ...
        <button
          ...
          className="md:hidden ml-auto rounded-full border border-solid border-surface-200 dark:border-surface-800 flex flex-col items-center justify-center gap-1 cursor-pointer p-0 relative shadow-md"
          style={{
            width: 'var(--nav-h)',
            height: 'var(--nav-h)',
            background: 'var(--base, #000)'
